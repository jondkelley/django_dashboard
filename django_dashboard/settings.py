...
sqlite_file =  os.path.abspath( os.path.dirname(__file__ )) + "/../sqlite3.db"
sqlite_file = os.path.normpath(sqlite_file)
...
SECRET_KEY = 'axja^@c_02d!9r_8dl!em6!5a=1v2__!z9i4qqb2nk4&=61#bp'
